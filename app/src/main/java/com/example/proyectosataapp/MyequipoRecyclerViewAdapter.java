...
import com.example.proyectosataapp.ui.dashboard.DashboardFragment.OnListFragmentInteractionListener;
...
public class MyequipoRecyclerViewAdapter extends RecyclerView.Adapter<MyequipoRecyclerViewAdapter.ViewHolder> {
    ...
    public MyequipoRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
